<template>
    <div class="shadow">
        <div class="win">
            ...
            <div class="content">InstallationChoseFile...
                <div>This is content text!</div>
                <div>
                    <input class="input_file" type="text" placeholder="c:\Program Files (x86)\VTech" />
                    <button class="btn_input no_drag" @click="clickChoseFile">chose your file</button>
                </div>
            <div id="showUrl"></div>
            </div>
            <div class="bottom">
                ...
                <router-link class="btn_same btn_continue no_drag" to="/InstallationProgress">Continue</router-link>
    ...
    * {
    ...
    .shadow {
        ...
        .win {
            ...
            width: 100%; //ȥ�����Ҽ���5px
            height: 100vh; //ȥ�����¼���5px
            background-color: #4cff00; //���õ�ɫΪ��ɫ
            border-radius: 20px; //Բ��20px
            //margin: 5px; //����������Ϊ5px
